						...
						<div class="col-lg-12">
							<div class="breadcrumb-content text-center">
								...
								<ul>
									...
									<?php
									foreach ($listcategories_tergether_products as $categories_tergether_products) {
										extract($categories_tergether_products);
									} ?>

									<li class="active"><a href="#"><?= $name_category ?></a></li>
											...
											<div class="product-wrapper product-wrapper-3 mb-40">
												<div class="product-img">
													<a href="#">
														...
														<!-- <img src="" alt="product" class="secondary" /> -->
													</a>
